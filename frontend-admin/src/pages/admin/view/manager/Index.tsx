...
import ContestManager from "pages/admin/view/manager/contest_manager/Index";
import ParticipantManager from "pages/admin/view/manager/participant_manager/Index";
import SectorRecordManager from "pages/admin/view/manager/sector_record_manager/Index";
import DriveRecordManager from "pages/admin/view/manager/drive_record_manager/Index";
import OperationMenu from "pages/admin/view/manager/operation_menu/Index";
import CounterDeviceLogManager from "pages/admin/view/manager/counter_device_log_manager/Index";
