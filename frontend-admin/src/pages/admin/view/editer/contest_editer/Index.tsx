...
import PostContest from "pages/admin/view/editer/contest_editer/PostContest";
import PutContest from "pages/admin/view/editer/contest_editer/PutContest";
import DeleteContestBtn from "pages/admin/view/editer/contest_editer/DeleteContestBtn";
