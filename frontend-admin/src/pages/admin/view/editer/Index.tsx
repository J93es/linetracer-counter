...
import ContestEditer from "pages/admin/view/editer/contest_editer/Index";
import ParticipantEditer from "pages/admin/view/editer/participant_editer/Index";
import SectorRecordEditer from "pages/admin/view/editer/sector_record_editer/Index";
import DriveRecordEditer from "pages/admin/view/editer/drive_record_editer/Index";
